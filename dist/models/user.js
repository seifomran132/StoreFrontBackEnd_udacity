...
var UsersModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        return [2 /*return*/, "User does not exist ".concat(err_2)];
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    // Create function to insert user to database
    UsersModel.prototype.show = function (u_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        return [2 /*return*/, "User does not exist ".concat(err_3)];
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UsersModel.prototype["delete"] = function (u_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'delete from users where users.id = $1 returning *';
                        return [4 /*yield*/, conn.query(sql, [u_id])];
                    case 2:
                        result = _a.sent();
                        conn.release(); // Release the connection
                    ...
                    case 3:
                        err_4 = _a.sent();
                        return [2 /*return*/, "Something went wrong ".concat(err_4)];
                    case 4: return [2 /*return*/];
                }
            });
        });

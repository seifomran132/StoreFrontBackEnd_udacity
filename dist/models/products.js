...
var ProductModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        return [2 /*return*/, "Could not find any products ".concat(err_1)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        return [2 /*return*/, "Something went wrong in creating product ".concat(err_2)];
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductModel.prototype.show = function (p_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [p_id])];
                    case 2:
                        result = _a.sent();
                        conn.release(); // Release the connection
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        err_3 = _a.sent();
                        return [2 /*return*/, "Something went wrong in getting the product ".concat(err_3)];
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductModel.prototype["delete"] = function (p_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'delete from product where product.id = $1 returning *';
                        return [4 /*yield*/, conn.query(sql, [p_id])];
                    case 2:
                        result = _a.sent();
                        conn.release(); // Release the connection
                    ...
                    case 3:
                        err_5 = _a.sent();
                        return [2 /*return*/, "Something went wrong ".concat(err_5)];
                    case 4: return [2 /*return*/];
                }
            });
        });
